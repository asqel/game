...
int register_entity(char *name, int sprite_id, double hx, double hy, double hw, double hh, double hp, int on_tick) {
	...
	entities_info[entities_len].on_tick_ref = on_tick;
