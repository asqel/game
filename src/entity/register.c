...
uint32_t entity_register(char *name, int sprite_id, int tick_ref, double hp, double world_hit[4], double drag, int8_t sprite_depth) {
	...
	info->hp = hp;
	info->drag = drag;
	info->sprite_depth = sprite_depth;
